    ...
    def parse(self, response, sport_name, event_url):
        try:
            ...
            try:
                ...
                #                     if template[translator_result['name']][translator_result['group']][translator_result['option']] < odd['oddNumber']:
                #                         template[translator_result['name']][translator_result['group']][translator_result['option']] = odd['oddNumber']
                #                 except:
                #                     pass
